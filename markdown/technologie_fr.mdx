...
#### Autres expertises :
- Développement et intégration d'API/API RESTful (avec Loopback 4, AdonisJS)
- Application et intégration full stack (avec AdonisJS et NextJS)
- Conception réactive
- Intégrations d'authentification Google
- Notification push, intégration de Google Maps
- API d'IA générative pour le texte et l'image (implémentation et intégration)
