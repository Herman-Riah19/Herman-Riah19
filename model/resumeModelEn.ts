...
const diplomasEn: Array<ResumeModel> = [
  {
    ...
    description:
      "Specialized in computer and telecommunications networks, with knowledge in desktop and web application programming. Configuration and troubleshooting of computer networks running on GNU/Linux infrastructures.",
  },
  {
    ...
    description:
      "Specialized in business management, finance, and accounting, with the aim of venturing into entrepreneurship and accounting. This course was pursued at the secondary level to enter a higher institute.",
  },
  {
    ...
    location: "Amboanjombe, Antananarivo",
    description:
      "This diploma is equivalent to a Higher Technical Diploma but at the secondary level, focused on basic management and IT (office automation, Word, Excel, PowerPoint). Inter-school training to integrate students into the job market.",
  },
];
...
const experiencesEn: Array<ResumeModel> = [
  ...
  },
  {
    ...
    description:
      "<ul className='list-disc'><li className='text-lg font-regular text-justify list-disc'>Contributing to the design of Jupiter, a money transaction platform, ensuring secure and efficient financial operations</li>" +
  ...
  },
  {
    ...
    href: "/",
    logoUrl: "/assets/icon/METFP.jpg",
    company: "Ministry of Technical Education and Vocational Training",
    location: "Ampefiloha, Antananarivo",
    description:
      "<ul className='list-disc'><li className='text-lg font-regular text-justify list-disc'>Developing a web application for an online library, where I integrated a page displaying video courses and a PDF reader within the app to enhance user experience and accessibility.</li>" +
  ...
  },
  {
    ...
    location: "Online",
    description:
      "A distance learning course on the SoloLearn platform, where I deepened my knowledge in Python, C/C++, JavaScript, and Dart, with participation in various challenges and competitions within the community.",
  },
];
