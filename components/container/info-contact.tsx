  ...
  return (
    <section className="mt-2">
      <ul
        ...
        className="md:grid sm:block grid-cols-3 gap-2 m-2"
      >
        <li>
          <Link
            href="https://github.com/Herman-Riah19"
            className="w-full rounded-3xl flex flex-row p-0 bg-secondary border-none gap-2 text-start text-white dark:text-black"
          >
            <Github className="m-2" />
            <span className="sm:text-md md:text-md text-normal mt-2">
              Herman-Ria19
            </span>
          </Link>
        </li>
